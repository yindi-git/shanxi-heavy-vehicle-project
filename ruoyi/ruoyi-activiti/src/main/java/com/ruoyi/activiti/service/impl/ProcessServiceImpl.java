...
public class ProcessServiceImpl implements IProcessService {
    ...
    public void complete(String taskId, String instanceId, String itemName, String itemContent, String module, Map<String, Object> variables, HttpServletRequest request) {
        ...
        String agencyUserCode = null;          // 代理人登录账户
        String agencyUserName = null;          // 代理人姓名
        String inventorUserCode = null;          // 发明人登录账户
        String inventorUserName = null;          // 发明人姓名
        boolean agree = true;
        try {
                ...
                if (parameterName.startsWith("p_")) {
                    ...
                    if (parameter.length == 3) {
                        ...
                        if (parameter[1].equals("B")) {
                            ...
                            comment = paramValue;
                        }else if (parameter[1].equals("AUC")) {
                            agencyUserCode = paramValue;
                        }else if (parameter[1].equals("AUN")) {
                            agencyUserName = paramValue;
                        }else if (parameter[1].equals("IUC")) {
                            inventorUserCode = paramValue;
                        }else if (parameter[1].equals("IUN")) {
                            inventorUserName = paramValue;
                        }
                        variables.put(parameter[2], value);
                        System.out.println("AAAAAAAAAAAAAAAAAAAAAAAAAAAA参数信息为："+variables.toString());
                    } else {
