...
$(document).ready(function(){
	$.validator.setDefaults({       
		...
		//贡献度验证 请填写大于0小于等于1的数字
	jQuery.validator.addMethod("isContribution",function(value,element){
		var contribution=/^{0.[0-9]}|0|1$/;
		return this.optional(element)||(contribution.test(value));
	},"请填写小于等于1的值！");
